...
public class ChupacabraEntity extends Monster implements GeoEntity, Enemy {
    ...
    public ChupacabraEntity(EntityType<? extends Monster> entityType, Level world) {
        super(entityType, world);
        this.xpReward = Enemy.XP_REWARD_MEDIUM;
    }

    public static AttributeSupplier.Builder setAttributes() {
        return Monster.createMobAttributes().add(Attributes.MAX_HEALTH, MythicMobsConfigs.chupacabraHealth)
                .add(Attributes.ATTACK_DAMAGE, MythicMobsConfigs.chupacabraAttackDamage)
