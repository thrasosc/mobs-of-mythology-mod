...
public class DrakeEggBlockEntity extends BlockEntity implements IAnimatable {
    ...
    public DrakeEggBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntityRegistry.DRAKE_EGG_BLOCK_ENTITY, pos, state);
    }

    @Override
    public void registerControllers(AnimationData animationData) {
        animationData.addAnimationController(new AnimationController<DrakeEggBlockEntity>(this, "controller", 0, this::predicate));
    }
