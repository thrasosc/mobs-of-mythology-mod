...
public class KoboldModel extends GeoModel<KoboldEntity> {
  ...
  public ResourceLocation getModelResource(KoboldEntity object) {
    return ResourceLocation.fromNamespaceAndPath(
        MobsOfMythology.MOD_ID, "geo/entity/kobold.geo.json");
  }
  ...
  public ResourceLocation getAnimationResource(KoboldEntity animatable) {
    return ResourceLocation.fromNamespaceAndPath(
        MobsOfMythology.MOD_ID, "animations/entity/kobold.animation.json");
  }

  @Override
  public void setCustomAnimations(
      KoboldEntity animatable, long instanceId, AnimationState<KoboldEntity> animationState) {
