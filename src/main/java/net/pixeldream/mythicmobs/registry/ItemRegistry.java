...
public class ItemRegistry {
    ...
    public static final KoboldSpearItem KOBOLD_SPEAR = new KoboldSpearItem(ToolMaterials.IRON, 4, 1, new Item.Settings().group(ITEM_GROUP).maxCount(1).rarity(Rarity.UNCOMMON));
