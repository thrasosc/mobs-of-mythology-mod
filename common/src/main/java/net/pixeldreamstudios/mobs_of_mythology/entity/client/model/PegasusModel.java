...
public class PegasusModel extends GeoModel<PegasusEntity> {
  ...
  public ResourceLocation getModelResource(PegasusEntity object) {
    return ResourceLocation.fromNamespaceAndPath(
        MobsOfMythology.MOD_ID, "geo/entity/pegasus.geo.json");
  }
  ...
  public ResourceLocation getAnimationResource(PegasusEntity animatable) {
    return ResourceLocation.fromNamespaceAndPath(
        MobsOfMythology.MOD_ID, "animations/entity/pegasus.animation.json");
  }

  @Override
  public void setCustomAnimations(
      PegasusEntity animatable, long instanceId, AnimationState<PegasusEntity> animationState) {
