...
public class DrakeRenderer extends GeoEntityRenderer<DrakeEntity> {
  public static final Map<DrakeVariant, ResourceLocation> LOCATION_BY_VARIANT =
      Util.make(
          Maps.newEnumMap(DrakeVariant.class),
          (map) -> {
            map.put(
                DrakeVariant.DRAKE_1,
                ResourceLocation.fromNamespaceAndPath(
                    MobsOfMythology.MOD_ID, "textures/entity/drake/drake_1.png"));
            map.put(
                DrakeVariant.DRAKE_2,
                ResourceLocation.fromNamespaceAndPath(
                    MobsOfMythology.MOD_ID, "textures/entity/drake/drake_2.png"));
            map.put(
                DrakeVariant.DRAKE_3,
                ResourceLocation.fromNamespaceAndPath(
                    MobsOfMythology.MOD_ID, "textures/entity/drake/drake_3.png"));
            map.put(
                DrakeVariant.DRAKE_4,
                ResourceLocation.fromNamespaceAndPath(
                    MobsOfMythology.MOD_ID, "textures/entity/drake/drake_4.png"));
            map.put(
                DrakeVariant.DRAKE_5,
                ResourceLocation.fromNamespaceAndPath(
                    MobsOfMythology.MOD_ID, "textures/entity/drake/drake_5.png"));
            map.put(
                DrakeVariant.DRAKE_6,
                ResourceLocation.fromNamespaceAndPath(
                    MobsOfMythology.MOD_ID, "textures/entity/drake/drake_6.png"));
            map.put(
                DrakeVariant.DRAKE_7,
                ResourceLocation.fromNamespaceAndPath(
                    MobsOfMythology.MOD_ID, "textures/entity/drake/drake_7.png"));
          });
