...
public class ItemRegistry {
  ...
  public static final RegistrySupplier<Item> AUTOMATON_SPAWN_EGG = ITEMS.register("automaton_spawn_egg",
                                                                                  () -> new ArchitecturySpawnEggItem(
                                                                                    ...
                                                                                    0xcf9611, 0xa87807,
                                                                                    new Item.Properties().arch$tab(
                                                                                      TabRegistry.MOBS_OF_MYTHOLOGY_TAB)));
  ...
  public static final RegistrySupplier<Item> SPORELING_SPAWN_EGG = ITEMS.register("sporeling_spawn_egg",
                                                                                  () -> new ArchitecturySpawnEggItem(
                                                                                    ...
                                                                                    new Item.Properties().arch$tab(
                                                                                      TabRegistry.MOBS_OF_MYTHOLOGY_TAB)));
  public static final RegistrySupplier<Item> BASILISK_SPAWN_EGG = ITEMS.register("basilisk_spawn_egg",
                                                                                 () -> new ArchitecturySpawnEggItem(
                                                                                   EntityRegistry.BASILISK,
                                                                                   0x586e7a, 0x323847,
                                                                                   new Item.Properties().arch$tab(
                                                                                     TabRegistry.MOBS_OF_MYTHOLOGY_TAB)));
  public static final RegistrySupplier<Item> PEGASUS_SPAWN_EGG = ITEMS.register("pegasus_spawn_egg",
                                                                                () -> new ArchitecturySpawnEggItem(
  ...
  // FOODS
  public static final RegistrySupplier<Item> CHUPACABRA_MEAT = ITEMS.register("chupacabra_meat", () -> new Item(
    new Item.Properties().food(new FoodProperties.Builder().nutrition(4)
  ...
  // MISCELLANEOUS
  public static final RegistrySupplier<Item> AUTOMATON_HEAD = ITEMS.register("automaton_head", () -> new Item(
    new Item.Properties().stacksTo(1)));
  public static final RegistrySupplier<Item> BASILISK_HEAD = ITEMS.register("basilisk_head", () -> new Item(
    new Item.Properties().stacksTo(1)));
  public static final RegistrySupplier<Item> BRONZE_INGOT = ITEMS.register("bronze_ingot", () -> new Item(
    new Item.Properties().stacksTo(64)
      .arch$tab(TabRegistry.MOBS_OF_MYTHOLOGY_TAB)));
  public static final RegistrySupplier<Item> GEAR = ITEMS.register("gear", () -> new Item(
    new Item.Properties().stacksTo(64)
      .arch$tab(TabRegistry.MOBS_OF_MYTHOLOGY_TAB)));
