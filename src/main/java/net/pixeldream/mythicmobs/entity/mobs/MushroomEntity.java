...
public class MushroomEntity extends MythicEntity implements GeoEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    public static final RawAnimation BOUNCE = RawAnimation.begin().thenPlay("bounce");
    protected static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT = SynchedEntityData.defineId(MushroomEntity.class, EntityDataSerializers.INT);
    ...
    public MushroomEntity(EntityType<? extends MythicEntity> entityType, Level world) {
    ...
    public static AttributeSupplier.Builder setAttributes() {
        return Monster.createMobAttributes()
                .add(Attributes.MAX_HEALTH, MythicMobsConfigs.mushroomHealth)
...
//    }
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        currentLine = Component.literal(lines.get(random.nextInt(lines.size())));
        if (talk) {
            touched = true;
            talk = false;
            startCountdown = true;
