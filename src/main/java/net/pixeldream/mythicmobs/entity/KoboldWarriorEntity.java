...
public class KoboldWarriorEntity extends PathAwareEntity implements IAnimatable, Monster {
    ...
    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT = DataTracker.registerData(KoboldWarriorEntity.class, TrackedDataHandlerRegistry.INTEGER);
    ...
    public KoboldWarriorVariant getVariant() {
        return KoboldWarriorVariant.byId(this.getTypeVariant() & 255);
    }
