...
public class BlockEntityRegistry {
    ...
    public BlockEntityRegistry() {
        ...
        DRAKE_EGG_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(MythicMobs.MOD_ID, "drake_egg_block_entity"), FabricBlockEntityTypeBuilder.create(DrakeEggBlockEntity::new, BlockRegistry.DRAKE_EGG_BLOCK).build(null));
    }
}
