package net.pixeldreamstudios.mobs_of_mythology.entity.task;
...
public abstract class AutomatonDelayedMeleeBehaviour<E extends AutomatonEntity> extends ExtendedBehaviour<E> {
    protected final int delayTime;
    protected long delayFinishedAt = 0;
    protected Consumer<E> delayedCallback = entity -> {
    };

    public AutomatonDelayedMeleeBehaviour(int delayTicks) {
     ...
     * @return this
     */
    public final AutomatonDelayedMeleeBehaviour<E> whenActivating(Consumer<E> callback) {
