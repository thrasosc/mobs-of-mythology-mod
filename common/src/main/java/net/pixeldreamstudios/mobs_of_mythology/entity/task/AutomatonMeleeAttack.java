...
public class AutomatonMeleeAttack<E extends AutomatonEntity> extends AutomatonDelayedMeleeBehaviour<E> {
    ...
    public AutomatonMeleeAttack(int delayTicks) {
        super(delayTicks);
    }
     ...
     * @return this
     */
    public AutomatonMeleeAttack<E> attackInterval(Function<E, Integer> supplier) {
