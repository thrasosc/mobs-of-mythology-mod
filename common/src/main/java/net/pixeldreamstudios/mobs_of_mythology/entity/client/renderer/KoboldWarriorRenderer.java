...
public class KoboldWarriorRenderer extends DynamicGeoEntityRenderer<KoboldWarriorEntity> {
  public static final Map<KoboldWarriorVariant, ResourceLocation> LOCATION_BY_VARIANT =
      Util.make(
          Maps.newEnumMap(KoboldWarriorVariant.class),
          (map) -> {
            map.put(
                KoboldWarriorVariant.KOBOLD_WARRIOR_1,
                ResourceLocation.fromNamespaceAndPath(
                    MobsOfMythology.MOD_ID, "textures/entity/kobold_warrior/kobold_warrior_1.png"));
            map.put(
                KoboldWarriorVariant.KOBOLD_WARRIOR_2,
                ResourceLocation.fromNamespaceAndPath(
                    MobsOfMythology.MOD_ID, "textures/entity/kobold_warrior/kobold_warrior_2.png"));
            map.put(
                KoboldWarriorVariant.KOBOLD_WARRIOR_3,
                ResourceLocation.fromNamespaceAndPath(
                    MobsOfMythology.MOD_ID, "textures/entity/kobold_warrior/kobold_warrior_3.png"));
          });
    ...
    addRenderLayer(
        new BlockAndItemGeoLayer<>(this) {
            ...
            return switch (bone.getName()) {
              case LEFT_HAND ->
                  animatable.isLeftHanded()
                      ? KoboldWarriorRenderer.this.mainHandItem
                      : KoboldWarriorRenderer.this.offHandItem;
              case RIGHT_HAND ->
                  animatable.isLeftHanded()
                      ? KoboldWarriorRenderer.this.offHandItem
                      : KoboldWarriorRenderer.this.mainHandItem;
          ...
          protected ItemDisplayContext getTransformTypeForStack(
              GeoBone bone, ItemStack stack, KoboldWarriorEntity animatable) {
